...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_selection=input("Enter selection from the menu : ")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items:
                    ...
                    menu_item_name_selected = menu_items[int(menu_selection)]['Item name']
                   
                    # Ask the customer for the quantity of the menu item
                    quantity = input(f"Please enter quantity of {menu_item_name_selected}. If quantity input is invalid, default quantity will be set to 1 ")
                    ...
                    if quantity.isdigit():
                     ...
                     quantity = 1
                     print ("As your input is invalid, the quantity is set to 1")
                     order_list.append ({
                            "Item Name": menu_item_name_selected,
                            "Price":float (menu_items[int(menu_selection)]['Price']),
                            "Quantity":int(quantity)
    ...
    while True:
        ...
        match keep_ordering:
            ...
            case 'n'|'N':
                place_order=False
                if  len(order_list )==0: # if no order placed. 
...
for item in order_list:
    ...
    Price = item["Price"]
    Quantity = item["Quantity"] # new variable created by Rajeev
